        ...
        <div className="p-6 border-b border-slate-700">
          <div className="flex items-center space-x-3">
            <div className="relative w-7 h-7">
              <Image src="/brand/logo.png" alt="AI Capital" fill className="object-contain" />
            </div>
          ...
          <div className="flex items-center space-x-3">
            {userAvatar ? (
              ...
              <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-slate-600 bg-slate-800">
                <Image src="/brand/logo.png" alt="AI Capital" width={40} height={40} className="w-full h-full object-cover" />
              </div>
            )}
            ...
            <div className="mb-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-slate-600 bg-slate-800">
                  <Image src="/brand/logo.png" alt="AI Capital" width={32} height={32} className="w-full h-full object-cover" />
                </div>
                       )}
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-white truncate">
