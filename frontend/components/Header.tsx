            ...
            <div className="flex items-center space-x-4">
              ...
              >
                  ...
                  <div className="text-right hidden sm:block">
                    <div className={`text-sm font-semibold ${(userReputation?.reputation || 0) >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                  ...
                  <div className="text-right sm:hidden">
                    <div className={`text-xs font-semibold ${(userReputation?.reputation || 0) >= 0 ? 'text-green-400' : 'text-red-400'}`}>
