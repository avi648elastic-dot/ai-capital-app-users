  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* Content - Compact with proper overflow */}
                      ...
                      {notification.actionData && (
                        <div className="mt-1.5 p-1.5 bg-slate-100 dark:bg-slate-700 rounded text-[10px]">
                          ...
                          {notification.actionData.ticker && (
                            <div>{notification.actionData.ticker} {notification.actionData.action || ''}</div>
                          )}
                          {notification.actionData.reason && (
                            <div className="truncate">{notification.actionData.reason}</div>
                          )}
                        </div>
                      )}
